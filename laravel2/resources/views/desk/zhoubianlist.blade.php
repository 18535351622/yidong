...
<div class="top" id="top">
    ...
    <div class="layout">
        ...
        <ul class="nav">
            <li><a href="/" >首页</a></li>
            <li><a href="/">国内游</a></li>
            <li><a href="zhoubian" class="select">周边游</a></li>
  ...
  <div class="tour">
    ...
    @foreach($arr as $v)
    	<div class="tourRight">
       	  <h1>{{$v['t_name']}}</h1>
	  		<ul class="tourMain">
		        <li>价格：<span class="tourPrice">{{$v['t_money']}}</span>元</li>
		        <li class="tourDateIe6">出行日期：<span class="no8 tourDateNO"></span><span class="tourDate">07.18-07.28</span> [查看其它时间段]</li>
			</ul>
            <div>
            	<span class="tourPStit">备注：</span>
                	<div class="tourPS">{{$v['t_text']}}</div>
            </div>
    	...
    	<div class="tourLeft">
        	<div class="tourPhoto"><img src="{{$v['t_file']}}" width="480" height="319" /></div>
