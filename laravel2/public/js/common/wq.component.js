;$(function($, window, document, undefined) {
	...
	$.extend({
		...
		wqDetailTip: function(opt) {
			...
			var close_btn = $('<i style="position:absolute;left:280px;top:5px;width:12px;height:12px;background:url(\'../../img/common/woqu-detail-all.png\') -389px -87px no-repeat;"></i>').appendTo(tip_wrapper);
